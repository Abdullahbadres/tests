    ...
    public function handle(OpenAIService $openAI): void
    {
        ...
        try {
            $content = $openAI->generateFullPage([
                ...
                'price_currency' => $this->salesPage->price_currency,
                'display_currency' => $this->salesPage->display_currency,
                'converted_price_display' => $this->salesPage->converted_price_display,
